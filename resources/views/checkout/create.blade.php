                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{ route('checkout.store', $camp->id) }}" method="POST" class="basic-form">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="card_number" class="form-control {{ $errors->has('card_number') ? 'is-invalid' : '' }}" value="{{ old('card_number') ?: Auth::user()->card_number }}" required>
                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input type="number" maxlength="3" name="cvc" class="form-control {{ $errors->has('cvc') ? 'is-invalid' : '' }}" value="{{ old('cvc') ?: Auth::user()->cvc }}" required>
                                            @if ($errors->has('cvc'))
